...
export function CourseDiscussionPrompt({ lesson, objectives, lessonById, subject = "large language models" }: { lesson: Lesson; objectives?: string[]; lessonById: Record<string, Lesson>; subject?: string }) {
  ...
  ].join("\n\n"), [lesson, objectives, prerequisiteTitles, subject]);
