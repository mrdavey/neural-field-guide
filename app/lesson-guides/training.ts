  ...
  "preference-optimization": {
    ...
    sections: [
      { title: "Preferences supervise differences", paragraphs: [
        ...
        "DPO increases the policy’s relative log-probability of chosen versus rejected responses, compared with the same gap under a fixed reference model. The reference acts as an anchor; the temperature-like beta controls update strength. RLHF with a reward model and policy optimization separates reward learning from policy search, allowing online sampling but introducing more instability and reward-hacking opportunities.",
      ] },
    ...
    walkthrough: [
      ...
      { title: "Optimize with guardrails", body: "Tune beta or KL strength, compare with the reference, and evaluate proxy-independent outcomes throughout training.", checkpoint: "A higher training preference margin can coexist with worse human quality." },
    ],
